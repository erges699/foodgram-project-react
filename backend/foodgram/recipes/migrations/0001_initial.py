# Generated by Django 3.2.15 on 2022-09-01 18:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, verbose_name='Название')),
                ('image', models.ImageField(help_text='Должна быть обязательно!', upload_to='images/', verbose_name='Ссылка на картинку на сайте')),
